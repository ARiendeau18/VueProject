<!--Reference: Coding with Justin on youtube for the google maps functionality through vue.js -->
<!--Adjustments to the lat/long will be made -->
<script>
...
export default {
    ...
    setup() {
        ...
        const distance = computed(() => otherPos.value === null
            ? 0
